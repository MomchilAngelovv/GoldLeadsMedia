    ...
    public partial class Initial_Database_Create : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CountryTiers", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CountryTierId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Offers_CountryTiers_CountryTierId",
                        column: x => x.CountryTierId,
                        principalTable: "CountryTiers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Offers_PayTypes_PayTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrackerClickId = table.Column<string>(nullable: true),
                    LeadId = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DepositAmmount = table.Column<decimal>(type: "decimal(18,4)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Offers_CountryTierId",
                table: "Offers",
                column: "CountryTierId");
