...
namespace GoldLeadsMedia.Database.Migrations
{
    ...
    [Migration("20200628133451_Initial_Database_Create")]
            ...
            modelBuilder.Entity("GoldLeadsMedia.Database.Models.ClickRegistration", b =>
                {
                    ...
                    b.Property<string>("TrackerClickId")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("GoldLeadsMedia.Database.Models.Offer", b =>
                {
                    ...
                    b.HasOne("GoldLeadsMedia.Database.Models.CountryTier", "CountryTier")
                        .WithMany()
                        .HasForeignKey("CountryTierId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
