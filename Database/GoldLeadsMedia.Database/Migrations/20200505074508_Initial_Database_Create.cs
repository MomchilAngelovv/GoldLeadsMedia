    ...
    public partial class Initial_Database_Create : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LeadErrors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LeadErrors_Leads_LeadId",
                        column: x => x.LeadId,
                        principalTable: "Leads",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LeadErrors_Partners_PartnerId",
                        column: x => x.PartnerId,
                        principalTable: "Partners",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeadErrors_LeadId",
                table: "LeadErrors",
                column: "LeadId");

            migrationBuilder.CreateIndex(
                name: "IX_LeadErrors_PartnerId",
                table: "LeadErrors",
                column: "PartnerId");
