namespace GoldLeadsMedia.Web.Controllers
{
    ...
    using GoldLeadsMedia.Web.Models.InputModels.Administration;
    ...
    public class AdministrationController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> CreateOffer(CreateOfferInputModel inputModel)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> AssignLandingPagesToOffer(AssignLandingPagesToOffersInputModel inputModel)
        {
            var reqeustBody = new
            {
                inputModel.OfferId,
